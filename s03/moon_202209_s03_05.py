...
#
# Time-stamp: <2022/09/29 13:04:08 (CST) daisuke>
#
...
try:
    n_steps = int (input ('number of steps (one step = 6-hr) to calculate: '))
except:
    print (f'Type an integer for number of steps.')
    sys.exit (1)
    
# date/time
t0_str = f'{YYYY:04d}-{MM:02d}-{DD:02d}T{hh:02d}:{mm:02d}:{ss:02d}'
...
# saving file
anim.save ('solsys_iss.mp4', dpi=225)
